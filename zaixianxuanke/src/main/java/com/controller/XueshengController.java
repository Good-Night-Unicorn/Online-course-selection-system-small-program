...
//            return R.error(511,"权限为空");
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids){
        ...
        ArrayList<XueshengEntity> list = new ArrayList<>();
        for(Integer id:ids){
            XueshengEntity xueshengEntity = new XueshengEntity();
            xueshengEntity.setId(id);
            xueshengEntity.setXueshengDelete(2);
            list.add(xueshengEntity);
        }
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            XueshengEntity xueshengEntity = new XueshengEntity();
//                            xueshengEntity.setUsername(data.get(0));                    //账号 要改的
...
//                            xueshengEntity.setXueshengYixiu(Integer.valueOf(data.get(0)));   //已修学分 要改的
//                            xueshengEntity.setXueshengYingxiu(Integer.valueOf(data.get(0)));   //应修学分 要改的
