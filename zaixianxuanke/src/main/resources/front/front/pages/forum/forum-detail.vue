<template>
	<view>
        ...
        <view class="username">
			<text v-if="forum.xueshengId != null">
				 发布人：{{forum.xueshengName}}（学生）
			</text>
			<text v-if="forum.jiaoshiId != null">
				 发布人：{{forum.jiaoshiName}}（教师）
			</text>
			...
			<view class="uni-article__comment-box" v-for="comment in commentData" :key="comment.id" >
				<view class="article-meta">
					<view class="article-header-image">
						<image v-if="comment.xueshengId != null" class="image" :src="comment.xueshengPhoto" mode="widthFix"></image>
						<image v-if="comment.jiaoshiId != null" class="image" :src="comment.jiaoshiPhoto" mode="widthFix"></image>
					...
					<view class="article-header-content">
						<view class="article-header-title">
							<text v-if="comment.xueshengId != null">{{comment.xueshengName}}</text>
							<text v-if="comment.jiaoshiId != null">{{comment.jiaoshiName}}</text>
